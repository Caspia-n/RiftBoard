...
Differential pair for usb data routing [2026-04-07 9:45] 
Decoupling caps [2026-04-07 10:00] 
...
Had problems with some of the GPIOs as the chip has them in top to bottom while the pin header has it the other way around, I am going to keep trying to make it work, if not then I will flip the row around.
